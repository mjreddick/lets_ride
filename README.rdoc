...
Let's Ride uses RSpec and Factory Girl for testing models and controllers. Tests are broken down into specific files in the app's spec directory. For example, to run all of the models tests, run:
